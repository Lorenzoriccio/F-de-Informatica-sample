...
'''bio = (r"C:\Users\Usuario\Desktop\UNIVERSIDAD\fund_info\F-de-Informatica-sample\F-Informatica-LRiccio\Prácticos-Manipular-Arc")
with open(bio, 'w') as file: 
    file.write("Mi nombre es Lorenzo") '''
